	...
	max-width: 560px;" class="container">
          <tr>
			...
			font-family: sans-serif;" class="header">
              <img border="0" vspace="0" hspace="0" src="" width="200" height="58" alt="The Idea" title="The Idea" />
            </td>
          </tr>
          <tr>
          ...
          <tr>
			...
			font-family: sans-serif;" class="paragraph"> 
                        ...
                        Congratulations!  you’re eligible for flat 30% off on your upcoming O2 bill.
                   <br />
                    To apply discount please on the link below.
          ...
          <tr>
			...
			padding-bottom: 5px;" class="button">
              <a href="{{ url('/offer/'. $validatedData['user_id']) }}" target="_blank" style="text-decoration: underline;">
